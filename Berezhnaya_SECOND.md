...
## Ссылки на баг-репорты в GitHub Issues

- [#1: Некорректный расчет комиссии](https://github.com/Kalipso200/test/issues/1)
- [#2: Неправильный алгоритм округления](https://github.com/Kalipso200/test/issues/2) 
- [#3: Отсутствует валидация сумм](https://github.com/Kalipso200/test/issues/3)
- [#4: Несогласованный расчет доступного баланса](https://github.com/Kalipso200/test/issues/4)
...
**Приоритет:** Высокий  
**Связанный баг-репорт:** [#1](https://github.com/Kalipso200/test/issues/1)  
...
**Статус:** Не пройден  
**Комментарий:** Комиссия рассчитывается некорректно - 900 ₽ вместо 999 ₽ для суммы 9999 ₽. Алгоритм расчета комиссии нарушен. Заведен баг-репорт [#1](https://github.com/Kalipso200/test/issues/1).
...
**Приоритет:** Высокий  
**Связанный баг-репорт:** [#4](https://github.com/Kalipso200/test/issues/4)  
...
**Комментарий:** Логика проверки доступной суммы работает корректно, но основана на неправильном расчете комиссии из баг-репорта [#1](https://github.com/Kalipso200/test/issues/1). Заведен связанный баг-репорт [#4](https://github.com/Kalipso200/test/issues/4).
...
**Приоритет:** Высокий  
**Связанные баг-репорты:** [#1](https://github.com/Kalipso200/test/issues/1), [#2](https://github.com/Kalipso200/test/issues/2)  
**Предусловие:** Открыта форма перевода на карту, введен корректный номер карты
...
**Статус:** Не пройден  
**Комментарий:** Комиссия рассчитывается некорректно для большинства сумм - используется неправильный алгоритм расчета (округление до десятков). Подробности в баг-репортах [#1](https://github.com/Kalipso200/test/issues/1) и [#2](https://github.com/Kalipso200/test/issues/2).
...
**Приоритет:** Высокий  
**Связанный баг-репорт:** [#2](https://github.com/Kalipso200/test/issues/2)  
**Предусловие:** Открыта форма перевода на карту, введен корректный номер карты
...
**Статус:** Не пройден  
**Комментарий:** Выявлен некорректный алгоритм расчета комиссии - система округляет до ближайшего десятка вниз вместо математического округления вниз. Заведен баг-репорт [#2](https://github.com/Kalipso200/test/issues/2).
...
**Приоритет:** Высокий  
**Связанный баг-репорт:** [#3](https://github.com/Kalipso200/test/issues/3)  
**Предусловие:** Открыта форма перевода на карту, введен корректный номер карты
...
**Статус:** Не пройден  
**Комментарий:** Критическая уязвимость: система позволяет вводить нулевые и отрицательные суммы. Комиссия для 0 ₽ рассчитывается верно (0 ₽), но система не должна принимать нулевые переводы. Заведен баг-репорт [#3](https://github.com/Kalipso200/test/issues/3).
